...
impl OneWireTemp {
    pub fn new(id: String, address: String) -> OneWireTemp {
...
impl OneWireAddress {
    pub fn from_string(s: String) -> Result<OneWireAddress, sensor::Error> {
        match &s[0..2] {
            "28" => {}
            _ => return Err(sensor::Error::InvalidAddressStart(s.clone())),
        }
        match s.len() {
            13 => {}
